...
declare module './integer' {
  ...
  namespace int32 {
    export type add<X extends numeric, Y extends numeric> = Decode<Integer.Add<Encode<X>, Encode<Y>>>
    export type sub<X extends numeric, Y extends numeric> = Decode<Integer.Sub<Encode<X>, Encode<Y>>>
    export type eq<X extends numeric, Y extends numeric> = Integer.Eq<Encode<X>, Encode<Y>>
    export type ne<X extends numeric, Y extends numeric> = Integer.Ne<Encode<X>, Encode<Y>>
    export type gt<X extends numeric, Y extends numeric> = Integer.Gt<Encode<X>, Encode<Y>>
    export type lt<X extends numeric, Y extends numeric> = Integer.Lt<Encode<X>, Encode<Y>>
    export type gte<X extends numeric, Y extends numeric> = Integer.Gte<Encode<X>, Encode<Y>>
    export type lte<X extends numeric, Y extends numeric> = Integer.Lte<Encode<X>, Encode<Y>>
  }
